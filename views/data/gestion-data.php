...
<div class="col-12 page-content p-5" id="content">
    ...
    <div class="pr-2">
        <h2 class='mt-2 thin-font'> Gestionar <b>Datos</b> y <b>Gráficos</b></h2>
        <hr>
        <div class="row pr-2">
            <div class="col-12 contenedor-gestion">
                ...
                <div class="col-sm bg-gris rounded p-2 mb-3">
                    ...
                    <a class="btn btn-warning" href="<?= base_url . 'data/downloadAndUnzip' ?>"><i class="fal fa-exclamation-triangle"></i></i> Descargar el repositorio y descomprimir todo <i class="fal fa-exclamation-triangle"></i></a>
                </div>
                <hr>
                <?php
            ...
            <div class="col-12 contenedor-gestion">
                ...
                <h3><b>Gráficos destacados</b></h3>
                <p>Aquí podras agregar, modificar y eliminar los gráficos destacados de la sección <b class="color-azul">Gráficos destacados</b>, para esto, primero se debe descargar el repositorio de <b class="color-azul">Github</b> que contiene los gráficos.</p>

                <button class="btn btn-primary" href="#modal-agregar-grafico" data-toggle="modal"><i class="fal fa-plus"></i> Agregar</button>
                <button class="btn btn-primary" id="btn_todos_graficos"><i class="fal fa-eye"></i> Ver todos</button>
                ...
                <form class="ajaxform mt-4" data-parsley-validate data-parsley-trigger="focusout" >
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-addon">
                            <button class="btn btn-primary form-control ml-1" id="btn_buscar_graficos"><i class="fal fa-search-plus"></i> Buscar</button>
                        </div>
                    </div>
                ...
                <form action="<?php echo base_url . 'contenido/updateDatos'; ?>" method="post" enctype="multipart/form-data" >
                    <div class="row">
                        ...
                        <div class="col-sm-2 text-left">
                            <input type="number" value="<?php if (isset($dato_millones) && $dato_millones->texto != '') {
                    echo $dato_millones->texto;
                } ?>" name="txtDatoMillones" class="form-control"/>
                        </div>
                        <div class="col-2 text-right align-self-center">
                            <label class="">Iniciativas apoyadas: </label>
                        </div>
                        <div class="col-2 text-left">
                            <input type="number" value="<?php if (isset($dato_iniciativas) && $dato_iniciativas->texto != '') {
                    echo $dato_iniciativas->texto;
                } ?>" name="txtDatoIniciativas"  class="form-control"/>
                        </div>
                        <div class="col-2 text-right align-self-center">
                            <label class="">Beneficiados: </label>
                        </div>
                        <div class="col-2 text-left">
                            <input type="number" value="<?php if (isset($dato_beneficiados) && $dato_beneficiados->texto != '') {
                    echo $dato_beneficiados->texto;
                } ?>" name="txtDatoBeneficiados" class="form-control"/>
                        </div>
                    </div>
                    <hr class="bc-celeste">
                    <div class="row justify-content-end">
                        <a href="<?= base_url . 'gestion/data' ?>" type="button" class="btn btn-danger mr-2" ><i class="fal fa-times"></i> Cancelar</a>
                        <button type="submit" class="btn btn-success mr-3"><i class="fal fa-save"></i> Guardar cambios</button>
                    </div>
                </form>
            </div>
