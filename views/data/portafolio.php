...
<iframe id="portafolio-shiny" frameborder="0" style="overflow:hidden;height:100vh;width:100%" height="90vh" width="100%" frameBorder='0' src="<?=$web->portafolio_link ? $web->portafolio_link : 'error' ?>">
</iframe>