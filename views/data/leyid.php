...
<iframe id="portafolio-shiny" frameborder="0" style="overflow:hidden;height:90vh;width:100%" height="90vh" width="100%" frameBorder='0' src="<?=$web->leyid_link ? $web->leyid_link : base_url.'web/error404' ?>">
</iframe>
