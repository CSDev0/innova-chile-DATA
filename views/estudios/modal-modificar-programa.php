...
<div id="modal-modificar-programa" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="<?= $url_action ?>" id="formulario-modificar-programa" method="post" enctype="multipart/form-data" accept=".doc,.docx,.ppt,.pptx,.html,.rtf,.txt,.xls,.xl"
                  data-parsley-validate data-parsley-trigger="focusout">
                <div class="modal-header">
                    <h3 class="modal-title thin-font">Modificar un <b>Programa</b></h3>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm mb-4">
                            <label for="slcAno">Año del programa<b class="color-rojo">*</b></label>
                            <?php
                            $antiguedad = 1900;
                            ?> 
                            <select class="form-control" id="slcAno-estudio" name="slcAno" required>
                                <?php
