...
<section class="seccion pb-5">
    <div class="row justify-content-center w-100">
        <div class="col-sm-12 align-self-top ">
            <div class="container">
                <h1 class="text-center" id="estudios_title"><i class="fad fa-folder-open icono-celeste"></i> Programas</h1>
                <hr class="faded" >
                <br>
                <div class="container">
                    <p><?= utils::getTextoByTipoContenido('Programas') ?></p>
                    <br>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-12 align-self-top vw-100">
        <div class="container">
            <ul class="dot-list">
                <?php
                $contador1 = 0;
                while ($est1 = $estudios->fetch_object()):
                    if ($est1->tipo == "programa") {
