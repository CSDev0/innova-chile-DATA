...
<div class="col-12 page-content p-5" id="content">
    ...
    <div class="pr-2">
        <h2 class='mt-2 thin-font'> Gestionar <b>Convocatorias</b></h2>
        <hr>
        <div class="row pr-2">
            ...
            <div class="col-12 contenedor-gestion">
                ...
                <button class="btn btn-primary" href="#modal-agregar-convocatoria" data-toggle="modal"><i class="fal fa-plus"></i> Agregar</button>
