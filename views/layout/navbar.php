<header>
    ...
    <nav class="navbar full-nav fixed-top navbar-expand-sm landing-page-navbar">
        ...
        <div class="navbar-collapse justify-content-center">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link landing-page-nav-link" href="#datos_destacados"><i class="fas fa-star icono-celeste"></i> Datos destacados</a>
                </li>
                <!--Graficos destacados es el #4-->
                <li class="nav-item">
                    <div class="dropdown">
                ...
                <li class="nav-item">
                    <div class="dropdown">
                        <a class="nav-link dropdown-toggle landing-page-nav-link" href="#estudios"><i class="fas fa-bookmark icono-celeste"></i> Estudios</a>
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" id="dropdown-item-hover6" href="#nuestros_estudios"><i class="fa fa-angle-double-right" id="nav-bar-dropdown-arrow6"></i> Nuestros estudios</a>
                            <a class="dropdown-item"  id="dropdown-item-hover7" href="#lecturas_recomendadas"><i class="fa fa-angle-double-right" id="nav-bar-dropdown-arrow7"></i> Lecturas recomendadas</a>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link landing-page-nav-link" href="#chile_en_el_mundo"><i class="fas fa-globe-americas icono-celeste"></i> Chile en el mundo</a>
                </li>
            </ul>
        </div>
