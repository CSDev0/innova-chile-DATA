    ...
    function estudios() {
        if (utils::isVerified()) {
            if (utils::isAdminOEmpleado()) {
                ...
                $estudio = new Estudio();
                $estudio2 = new Estudio();
                $estudio3 = new Estudio();
                ...
                require_once("views/estudios/modal-agregar-programa.php");
                require_once("views/estudios/modal-modificar-programa.php");
                require_once("views/mensajes/modal-eliminar.php");
            } else {
