        ...
        if ($obj['tipo'] == "estudio") {
            ...
            $output .= '
                    <tr>
                            ...
                            <td>
                        <a href="#modal-modificar-nuestro-estudio" data-toggle="modal" class="btn btn-success" style="width: 100%;" 
 id=' . $obj['id'] . ' nombre=' . $obj['nombre'] . ' ano_estudio=' . $obj['ano_estudio'] . ' archivo=' . $obj['archivo'] . ' fecha_creacion=' . $obj['fecha_creacion'] . ' >
