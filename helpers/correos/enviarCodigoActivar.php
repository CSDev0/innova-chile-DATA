...
$correo_mensaje .= "</div>";
$correo_mensaje .= "<h2 style='font-size: 25px; color: #2680BD; text-align: center;'>Activa tu cuenta.</h2>";
...
$correo_mensaje .= "<span style='font-size: 18px; color: gray; text-align: left;'>Debes ingresar el siguiente codigo en la pagina para poder activar tu cuenta.</span><br>";
